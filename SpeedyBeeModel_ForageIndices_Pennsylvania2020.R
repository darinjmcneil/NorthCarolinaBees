...
plot(Pennsylvania$geometry) # nice!

# use NC polygon to extract CDL for PA

CroppedCDL <- crop(cdl_2020, PennsylvaniaBoundary) # crop CDL using PA boundary polygon
...
writeRaster(MaskedCDL, "E:\\2021_NC_Bees\\NorthCarolinaBees2021\\PA_CDL2020_Raster.tif", overwrite = TRUE) # takes a minute or two
# unique(MaskedCDL)
# dev.off()
# hist(MaskedCDL)
...
SpeedyBeeModel::forage_index( 
    output_dir = "E:\\2021_NC_Bees\\NorthCarolinaBees2021\\PA2020_LonsdorfIndices", # output loc
    landcover_path  = "E:\\2021_NC_Bees\\NorthCarolinaBees2021\\PA_CDL2020_Raster.tif", # path to NC CDL map
...
PAfloral <- raster("E:\\2021_NC_Bees\\NorthCarolinaBees2021\\PA2020_LonsdorfIndices\\PA_CDL2020_Raster_Floral_Spring.tif")
plot(PAfloral)

PAnest <- raster("E:\\2021_NC_Bees\\NorthCarolinaBees2021\\PA2020_LonsdorfIndices\\PA_CDL2020_Raster_Nest_Cavity.tif")
plot(PAnest)
